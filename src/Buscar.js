    ...
    return (
        <div className="Container-fluid mt-3">
            <div className='row'>
                ...
                <div className="mb-3">
                    <label id='nomproduc' className="form-label">Nombre producto</label>
                    <input required type="text" name="nombre" value={nombre}
                        id='barra' className="form-control" onChange={(e) => { handleOnChange(e) }} />
                </div>
                <button type="submit" className="btn btn-primary" id='botonguardar'>Guardar</button>
            </form>
                </div>
